...
> **Note on location:** temporarily hosted in `bankimport/docs/` because the first concrete work
> (the "keystone") lands in `bankimport`. Move to the new module once it is generated.
